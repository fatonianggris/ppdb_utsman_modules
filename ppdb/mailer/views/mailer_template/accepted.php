                                                                                    ...
                                                                                    <tr>
                                                                                        <td height="500" class="autoheight" align="center" valign="middle">
                                                                                            ...
                                                                                            <table  border="0" width="100%" cellpadding="0" cellspacing="0" align="center" style="width:100%; max-width:100%;">
                                                                                                <tr> 
                                                                                                    <td class="text center-text" valign="middle" align="left" style="font-family:'Poppins',Arial,Helvetica,sans-serif; font-size:14px; line-height:23px; font-weight:bold;font-style:normal; color:#F64E60;text-decoration:none;letter-spacing: 0px;">
                                                                                                        Selamat datang di Sekolah Utsman, Berikut merupakan informasi terkait data diri Anda:
                                                                                                    </td>
                                                                                                </tr>
                                                                                            </table>
                                                                                            <!-- text -->
                                                                                            ...
                                                                                            <table  border="0" width="100%" cellpadding="0" cellspacing="0" align="center" style="width:100%; max-width:100%;">
                                                                                                <tr> 
                                                                                                    <td class="text center-text" valign="middle" align="left" style="font-family:'Poppins',Arial,Helvetica,sans-serif; font-size:14px; line-height:23px; font-weight:bold;font-style:normal; color:#F64E60;text-decoration:none;letter-spacing: 0px;">
                                                                                                        <b>NIS/NISN</b> Anda bersifat <strong style="color:#F64E60;">RAHASIA</strong>, Dimohon untuk tidak menunjukan kepada siapapun. Kami tidak bertanggung jawab atas segala konsekuensi yang ada.
                                                                                                    </td>
                                                                                                </tr>
                                                                                            </table>
                                                                                            <!-- text -->
