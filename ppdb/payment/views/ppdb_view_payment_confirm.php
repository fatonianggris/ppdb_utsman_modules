                    ...
                    <div class="card card-custom gutter-b">
                        <div class="card-body">
                                    ...
                                    <select name="voucher" id="voucher" <?php echo $disable; ?>  class="form-control form-control-lg form-control-solid" >
                                        <?php if ($register[0]->id_voucher != NULL or $register[0]->id_voucher != "") { ?>
                                            <option value="<?php echo $register[0]->id_voucher; ?>" selected="">    
                                                <?php echo $register[0]->kode_voucher; ?>
                                            </option>
                                        <?php } else { ?>
                                        ...
                                        if (!empty($voucher)) {
                                            foreach ($voucher as $key => $value) {
                                                ?>
                                                <option value="<?php echo $value->id_voucher; ?>"><?php echo $value->kode_voucher; ?>-<?php echo $value->potongan; ?>% (<?php echo $value->jumlah_voucher; ?>) </option>                                     
                                                <?php
                                            }
                                        }
                                        ?>         
                            ...
                            <div class="text-center">
                                <button class="btn btn-primary font-weight-bold px-9 py-4 my-3 mx-4" data-toggle="modal" data-target="#modal_bukti"><i class="fa fa-eye"></i>Tampilkan Bukti</button>
                            </div>
                        </div>
                    </div>
                    <!--end::Card-->
...
<script>
    ...
    function act_confrim_payment(id, name) {
        ...
        Swal.fire({
            title: "Peringatan!",
            text: "Apakah anda yakin ingin MENSETUJUI Bukti Siswa " + name + "?",
            icon: "warning",
            ...
            preConfirm: () => {
                return $.ajax({
                    ...
                    data: {id: id, id_voucher: id_voucher, [csrfName]: csrfHash},
                    dataType: 'html',
