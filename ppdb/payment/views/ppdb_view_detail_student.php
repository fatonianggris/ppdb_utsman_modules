        ...
        <div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex flex-column">
                    <!--begin::Title-->
                    <h2 class="text-white font-weight-bold my-2 mr-5">Konfirmasi Pembayaran</h2>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
                    <div class="d-flex align-items-center font-weight-bold my-2">
                        ...
                        <a href="" class="text-white text-hover-white opacity-75 hover-opacity-100">Pembayaran</a>
                        <!--end::Item-->
                        <!--begin::Item-->
                        <span class="label label-dot label-sm bg-white opacity-75 mx-3"></span>
                        <a href="" class="text-white text-hover-white opacity-75 hover-opacity-100">Daftar Konfirmasi Pembayaran</a>
                        <!--end::Item-->
                    </div>
                    <!--end::Breadcrumb-->
                </div>
                ...
                <div class="col-xl-2">
                    ...
                    <div class="card card-custom bg- gutter-b" >
                        <div class="card-body">
                            ...
                            <a href="#" class="text-inverse-primary font-weight-bold font-size-lg mt-1 text-muted">Total Bukti Transfer</a>
                        </div>
                    </div>
                    <!--end::Tiles Widget 11-->
                </div>
                ...
                <div class="col-xl-2">
                    ...
                    <div class="card card-custom bg-warning gutter-b" >
                        <div class="card-body">
                            ...
                            <div class="text-inverse-primary font-weight-bolder font-size-h2 mt-3 text-white">790</div>
                            <a href="#" class="text-inverse-primary font-weight-bold font-size-lg mt-1 text-white">Bukti Dalam Proses</a>
                        </div>
                    </div>
                    <!--end::Tiles Widget 11-->
                    <!--end::Stat: Widget 28-->
