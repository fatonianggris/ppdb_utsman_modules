				...
				<div class="col-xl-2">
					...
					<div class="card card-custom bg- gutter-b">
						<div class="card-body">
							...
							<a href="#" class="text-inverse-primary font-weight-bold font-size-lg mt-1 text-muted">Total Voucher</a>
						</div>
					</div>
					<!--end::Tiles Widget 11-->
				</div>
				...
				<div class="col-xl-2">
					...
					<div class="card card-custom bg-success gutter-b">
						<div class="card-body">
							...
							<a href="#" class="text-inverse-primary font-weight-bold font-size-lg mt-1 text-white">Voucher Terpakai</a>
						</div>
					</div>
					<!--end::Tiles Widget 11-->
				</div>
				<div class="col-xl-3">
					...
					<div class="card card-custom bg-warning gutter-b">
						<div class="card-body">
							...
							<div class="text-inverse-primary font-weight-bolder font-size-h2 mt-3 text-white">790</div>
							<a href="#" class="text-inverse-primary font-weight-bold font-size-lg mt-1 text-white">Voucher Belum Terpakai</a>
						</div>
					</div>
					<!--end::Tiles Widget 11-->
					<!--end::Stat: Widget 28-->
							...
							<div class="mb-7">
								<div class="row align-items-center">
									...
									<div class="col-lg-3 col-xl-4 text-right">
										<a href="<?php echo site_url("/ppdb/payment/voucher/add_voucher"); ?>" class="btn btn-primary btn-md">
								...
								<tbody>
									...
									?>
											<tr>
												...
												<td><?php echo $value->nama_voucher; ?></td>
												<td><b class="text-danger"><?php echo $value->potongan; ?>%</b></td>
												<td><?php echo $value->jumlah_voucher; ?></td>
												<td><?php echo $value->voucher_terpakai; ?></td>
													...
													<div class="dropdown dropdown-inline">
														...
														<div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
															<ul class="navi flex-column navi-hover py-2">
																...
																<li class="navi-item">
																	<a href="<?php echo site_url("/ppdb/payment/voucher/edit_voucher/" . paramEncrypt($value->id_voucher)); ?>" class="navi-link">
	...
	function act_delete_voucher(id, name) {
		...
		Swal.fire({
			...
			if (result.value) {
				$.ajax({
					type: "post",
					url: "<?php echo site_url("/ppdb/payment/voucher/delete_voucher") ?>",
					data: {
						id: id,
						[csrfName]: csrfHash
					},
