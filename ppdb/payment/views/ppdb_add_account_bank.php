			...
			<div class="d-flex align-items-center flex-wrap mr-1">
				...
				<div class="d-flex flex-column">
					...
					<div class="d-flex align-items-center font-weight-bold my-2">
						...
						<!--begin::Item-->
						<span class="label label-dot label-sm bg-white opacity-75 mx-3"></span>
						<a href="" class="text-white text-hover-white opacity-75 hover-opacity-100">Tambah Rekening Bank</a>
						<!--end::Item-->
					</div>
					<!--end::Breadcrumb-->
				</div>
				...
				<div class="col-lg-12" id="kt_form">
					...
					<div class="card card-custom">
						<div class="card-header">
							<h3 class="card-title">
								Tambah Rekening/Alat Bayar Pembayaran
							</h3>
						</div>
						<!--begin::Form-->
						<form class="form" novalidate="novalidate" action="<?php echo site_url('ppdb/payment/bankaccount/post_bank_account'); ?>" enctype="multipart/form-data" method="post" id="kt_add_account_bank_form">
								...
								<div class="row">
									...
									<div class="col-lg-4">
										<div class="form-group">
											...
											<input type="text" name="nama_alatbayar" class="form-control form-control-lg" placeholder="Isikan Nama Jasa Alat Bayar" />
									...
									<div class="col-lg-3">
										<div class="form-group">
											...
											<input type="text" name="atas_nama" class="form-control  form-control-lg" placeholder="Isikan Atas Nama Pemilik" />
									...
									<div class="col-lg-3">
										<div class="form-group">
											...
											<input type="text" name="nomor_alatbayar" class="form-control  form-control-lg" placeholder="Isikan Nomor Alat Bayar" />
								...
								<div class="row">
									<div class="col-lg-12">
										<div class="form-group">
											...
											<input type="file" class="dropify" name="logo_instansi" data-max-file-size="1M" data-height="200" data-allowed-file-extensions="png jpg jpeg" />
										...
										<div class="accordion accordion-solid accordion-toggle-arrow" id="accordionExample3">
											<div class="card">
												...
												<div id="collapseOne3" class="collapse" data-parent="#accordionExample3">
													<div class="card-body">
														<textarea name="catatan_transfer" id="kt-ckeditor-1"></textarea>
										...
										<div class="accordion accordion-solid accordion-toggle-arrow mt-5" id="accordionExample2">
											<div class="card">
												...
												<div id="collapseOne2" class="collapse " data-parent="#accordionExample2">
													<div class="card-body">
														<textarea name="petunjuk_transfer" id="kt-ckeditor-2"></textarea>
