        ...
        <div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex flex-column">
                    <!--begin::Title-->
                    <h2 class="text-white font-weight-bold my-2 mr-5">Tagihan</h2>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
                ...
                <div class="col-xl-2 col-6">
                    ...
                    <div class="card card-custom bg- gutter-b">
                        <div class="card-body">
                            ...
                            <div class="text-inverse-primary font-weight-bolder font-size-h2 mt-3 text-dark">
                                <?php echo $insight_bill[0]->total_tagihan; ?></div>
                            <a href="#" class="text-inverse-primary font-weight-bold font-size-lg mt-1 text-muted">Total
                                Tagihan</a>
                        </div>
                    </div>
                    <!--end::Tiles Widget 11-->
                    ...
                    <div class="card card-custom bg-warning gutter-b">
                        <div class="card-body">
                            <span class="svg-icon svg-icon-3x svg-icon-white ml-n2">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                    ...
                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                        ...
                                        <path
                                            d="M14.5,12 C15.0522847,12 15.5,12.4477153 15.5,13 L15.5,16 C15.5,16.5522847 15.0522847,17 14.5,17 L9.5,17 C8.94771525,17 8.5,16.5522847 8.5,16 L8.5,13 C8.5,12.4477153 8.94771525,12 9.5,12 L9.5,11.5 C9.5,10.1192881 10.6192881,9 12,9 C13.3807119,9 14.5,10.1192881 14.5,11.5 L14.5,12 Z M12,10 C11.1715729,10 10.5,10.6715729 10.5,11.5 L10.5,12 L13.5,12 L13.5,11.5 C13.5,10.6715729 12.8284271,10 12,10 Z"
                                            fill="#000000" />
                                    </g>
                            ...
                            <div class="text-inverse-primary font-weight-bolder font-size-h2 mt-3 text-white">
                                <?php echo $insight_bill[0]->belum_ditagih; ?></div>
                            <a href="#" class="text-inverse-primary font-weight-bold font-size-lg mt-1 text-white">Belum
                                Ditagih</a>
                        </div>
                    </div>
                    <!--end::Tiles Widget 11-->
                ...
                <div class="col-xl-2 col-6">
                    ...
                    <div class="card card-custom bg-success gutter-b">
                        <div class="card-body">
                            ...
                            <div class="text-inverse-primary font-weight-bolder font-size-h2 mt-3 text-white">
                                <?php echo $insight_bill[0]->sudah_ditagih; ?></div>
                            <a href="#" class="text-inverse-primary font-weight-bold font-size-lg mt-1 text-white">Sudah
                                Ditagih</a>
                        </div>
                    </div>
                    <!--end::Tiles Widget 11-->
                    ...
                    <div class="card card-custom card-stretch gutter-b">
                        <div class="card-body d-flex p-0">
                            <div class="flex-grow-1 bg-info p-5 card-rounded flex-grow-1 bgi-no-repeat"
                                style="background-position: calc(100% + 0.8rem) bottom;background-size: auto 60%;background-image: url(<?php echo base_url(); ?>assets/students/dist/assets/media/svg/files/jpg.svg);">
                                <h4 class="text-inverse-danger font-weight-bolder">Info Penting</h4>
                                <p class="text-inverse-danger my-2">Pastikan saat menagih sudah sesuai dengan jumlah
                                    tagihan dan sudah mengiputkan tagihan di web BSI</p>
                    ...
                    <div class="card card-custom">
                        <div class="card-body">
                                    ...
                                    <div class="col-lg-12 col-xl-12">
                                        <div class="row align-items-center">
                                                    ...
                                                    <div class="col-md-4 my-2 my-md-0">
                                                        <div class="d-flex align-items-center">
                                                            <select class="form-control"
                                                                id="kt_datatable_search_program">
                                            ...
                                            <div class="col-md-2 my-2 my-md-0">
                                                <div class="d-flex align-items-center">
                                                    <select class="form-control" id="kt_datatable_search_bill">
                            ...
                            <table class="datatable datatable-bordered datatable-head-custom"
                                id="kt_datatable_bill_payment_ppdb">
                                <thead>
                                    <tr>
                                            ...
                                            <div class="dropdown dropdown-inline">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                                                    <ul class="navi flex-column navi-hover py-2">
                                                        ...
                                                        <li class="navi-item">
                                                            <a href="<?php echo site_url("/ppdb/payment/payment_confirm_bill_ppdb/" . paramEncrypt($value->id_formulir)); ?>"
                                                                class="navi-link">
                                                                <span class="navi-icon"><i
                                                                        class="la la-search text-success"></i></span>
                                                                <span class="navi-text">Penagihan</span>
                                                            </a>
                                                        </li>
                                                    </ul>
                                                </div>
...
<!--end::Content-->
<script
    src="<?php echo base_url(); ?>assets/ppdb/dist/assets/js/pages/crud/ktdatatable/base/html-table-bill-payment-ppdb.js">
</script>
