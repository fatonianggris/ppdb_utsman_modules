			...
			<div class="row">
				<div class="col-lg-12" id="kt_form">
					...
					<div class="card card-custom">
						...
						<!--begin::Form-->
						<form class="form" novalidate="novalidate" action="<?php echo site_url('ppdb/payment/cost/post_cost'); ?>" enctype="multipart/form-data" method="post" id="kt_add_cost_form">
