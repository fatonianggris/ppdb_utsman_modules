				...
				<div class="col-xl-3">
					...
					<div class="card card-custom bg- gutter-b">
						<div class="card-body">
							...
							<a href="#" class="text-inverse-primary font-weight-bold font-size-lg mt-1 text-muted">Total Biaya</a>
						</div>
					</div>
					<!--end::Tiles Widget 11-->
				</div>
				...
				<div class="col-xl-3">
					...
					<div class="card card-custom bg-success gutter-b">
						<div class="card-body">
							...
							<a href="#" class="text-inverse-primary font-weight-bold font-size-lg mt-1 text-white">Total Tipe Biaya</a>
						</div>
					</div>
					<!--end::Tiles Widget 11-->
				</div>
													...
													<div class="dropdown dropdown-inline">
														...
														<div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
															<ul class="navi flex-column navi-hover py-2">
																...
																<li class="navi-item">
																	<a href="<?php echo site_url("/ppdb/payment/cost/edit_cost/" . paramEncrypt($value->id_biaya)); ?>" class="navi-link">
	...
	function act_delete_cost(id, name) {
		...
		Swal.fire({
			...
			if (result.value) {
				$.ajax({
					type: "post",
					url: "<?php echo site_url("/ppdb/payment/cost/delete_cost") ?>",
					data: {
						id: id,
						[csrfName]: csrfHash
					},
