				...
				<div class="col-lg-12">
					...
					<div class="card card-custom">
						<div class="card-body">
							...
							<!--end: Search Form-->
							<!--begin: Datatable-->
							<table class="datatable datatable-bordered datatable-head-custom" id="kt_datatable_confirm_payment_ppdb">
								<thead>
									<tr>
													...
													<div class="dropdown dropdown-inline">
														...
														<div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
															<ul class="navi flex-column navi-hover py-2">
																...
																<li class="navi-item">
																	<a href="<?php echo site_url("/ppdb/payment/payment_confirm_ppdb/" . paramEncrypt($value->id_formulir)); ?>" class="navi-link">
...
<!--end::Content-->
<script src="<?php echo base_url(); ?>assets/ppdb/dist/assets/js/pages/crud/ktdatatable/base/html-table-confirm-payment-ppdb.js">
</script>
