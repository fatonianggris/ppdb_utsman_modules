																				...
																				<tr>
																					<td height="500" class="autoheight" align="center" valign="middle">
																						...
																						<table border="0" width="100%" cellpadding="0" cellspacing="0" align="center" style="width:100%; max-width:100%; margin-bottom: 5px;">
																							<tr>
																								<td class="text center-text" valign="middle" align="center" style="font-family:'Poppins',Arial,Helvetica,sans-serif; font-size:14px; line-height:23px; font-weight:normal;font-style:normal; color:#000000;text-decoration:none;letter-spacing: 0px;">
																									Terimakasih telah melakukan pembayaran. Pembayaran <b>Formulir PPDB Anda</b> telah <b style="color:#000000;">KAMI TERIMA</b>.
																								</td>
																							</tr>
																						</table>
																						<!-- text -->
																						...
																						<?php if ($register[0]->id_voucher != NULL or $register[0]->id_voucher != "") { ?>
																							...
																							<table border="0" width="100%" cellpadding="0" cellspacing="0" align="center" style="width:100%; max-width:100%;">
																								<tr>
																									<td class="text center-text" valign="middle" align="center" style="font-family:'Poppins',Arial,Helvetica,sans-serif; font-size:16px; line-height:23px; font-weight:bold;font-style:normal; color:#1BC5BD;text-decoration:none;letter-spacing: 0px;">
																							...
																							<table width="100%" style="border: 3px dashed #f77d0e; margin-top: 10px;">
																								<thead>
																									<tr>
																										<th align="left" class="img180"">
                                                                                                                <img style=" display:block;width:100%;max-width:100%;border:0px; margin-right:35px;" src="<?php echo base_url() . $page[0]->logo_website; ?>" border="0" alt="logo">
																										</th>
																												...
																												<tbody>
																													<tr>
																														<td align="left" style="text-align: left;">
																															...
																															<p style="color:#F64E60; font-size: x-small; margin-top: 0px; margin-bottom: 0px; font-weight: normal; ">*download file untuk melihat syarat dan ketentuan.</p>
																														</td>
																													</tr>
																												</tbody>
																											</table>
																						...
																						<!-- text -->
																						<!-- text -->
																						<table border="0" width="100%" cellpadding="0" cellspacing="0" align="center" style="width:100%; max-width:100%; margin-top: 8px;">
																							<tr>
																								<td class="text center-text" valign="middle" align="center" style="font-family:'Poppins',Arial,Helvetica,sans-serif; font-size:13px; line-height:23px; font-weight:normal;font-style:normal; color:#000000;text-decoration:none;letter-spacing: 0px;">
																									<table border="2" width="100%" cellpadding="1" cellspacing="1" align="center" style="width:100%; max-width:100%;">
																										<thead style="background-color: #FFF4DE;">
