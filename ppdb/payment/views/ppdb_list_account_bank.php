		...
		<div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
			...
			<div class="d-flex align-items-center flex-wrap mr-1">
				...
				<div class="d-flex flex-column">
					<!--begin::Title-->
					<h2 class="text-white font-weight-bold my-2 mr-5">Rekening Bank</h2>
					<!--end::Title-->
					<!--begin::Breadcrumb-->
					<div class="d-flex align-items-center font-weight-bold my-2">
						...
						<!--begin::Item-->
						<span class="label label-dot label-sm bg-white opacity-75 mx-3"></span>
						<a href="" class="text-white text-hover-white opacity-75 hover-opacity-100">Daftar Rekening Bank</a>
						<!--end::Item-->
					</div>
					<!--end::Breadcrumb-->
				</div>
				...
				<div class="col-xl-3">
					...
					<div class="card card-custom bg- gutter-b">
						<div class="card-body">
							...
							<div class="text-inverse-primary font-weight-bolder font-size-h2 mt-3 text-dark">790</div>
							<a href="#" class="text-inverse-primary font-weight-bold font-size-lg mt-1 text-muted">Total Rekening</a>
						</div>
					</div>
					<!--end::Tiles Widget 11-->
				</div>
				...
				<div class="col-xl-3">
					...
					<div class="card card-custom bg-success gutter-b">
						<div class="card-body">
							...
							<a href="#" class="text-inverse-primary font-weight-bold font-size-lg mt-1 text-white">Rekening Terpakai</a>
						</div>
					</div>
					<!--end::Tiles Widget 11-->
				</div>
				...
				<div class="col-xl-6">
					...
					<div class="card card-custom card-stretch gutter-b">
						<div class="card-body d-flex p-0">
							<div class="flex-grow-1 bg-info p-5 card-rounded flex-grow-1 bgi-no-repeat" style="background-position: calc(100% + 0.8rem) bottom;background-size: auto 60%;background-image: url(<?php echo base_url(); ?>assets/students/dist/assets/media/svg/files/jpg.svg);">
							...
							<div class="mb-7">
								<div class="row align-items-center">
									...
									<div class="col-lg-3 col-xl-4 text-right">
										<a href="<?php echo site_url("/ppdb/payment/bankaccount/add_bank_account"); ?>" class="btn btn-primary btn-md">
								...
								<tbody>
									...
									?>
											<tr>
												...
												<td><?php echo $value->nama_alatbayar; ?></td>
													...
													<div class="dropdown dropdown-inline">
														...
														<div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
															<ul class="navi flex-column navi-hover py-2">
																...
																<li class="navi-item">
																	<a href="<?php echo site_url("/ppdb/payment/bankaccount/edit_bank_account/" . paramEncrypt($value->id_alat_bayar)); ?>" class="navi-link">
	...
	function act_delete_bank_account(id, name) {
		...
		Swal.fire({
			...
			if (result.value) {
				$.ajax({
					type: "post",
					url: "<?php echo site_url("/ppdb/payment/bankaccount/delete_bank_account") ?>",
					data: {
						id: id,
						[csrfName]: csrfHash
					},
	...
	function act_activate_bank_account(id, name) {
		...
		Swal.fire({
			...
			if (result.value) {
				$.ajax({
					type: "post",
					url: "<?php echo site_url("ppdb/payment/bankaccount/activate_bank_account") ?>",
					data: {
						id: id,
						[csrfName]: csrfHash
					},
	...
	function act_disable_bank_account(id, name) {
		...
		Swal.fire({
			...
			if (result.value) {
				$.ajax({
					type: "post",
					url: "<?php echo site_url("ppdb/payment/bankaccount/disable_bank_account") ?>",
					data: {
						id: id,
						[csrfName]: csrfHash
					},
