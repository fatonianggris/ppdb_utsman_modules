                                ...
                                <div class="flex-shrink-0 mr-0">
                                    <?php if ($formulir[0]->foto_siswa == NULL or $formulir[0]->foto_siswa == "") { ?>
                                        <div class="symbol symbol-50 symbol-lg-100 symbol-light-danger">
                                            <span class="font-size-h2 symbol-label font-weight-boldest"><?php echo strtoupper(substr($formulir[0]->nama_lengkap, 0, 2)); ?></span>
                                        </div>
                                    <?php } else { ?>
                                    ...
                                    <div class="d-flex align-items-center justify-content-between flex-wrap">
                                        ...
                                        <div class="mr-2">
                                            <div class="d-flex align-items-center mr-2">
                                                <!--begin::Name-->
                                                <a href="#" class="d-flex align-items-center text-dark text-hover-primary font-size-h5 font-weight-bold mr-3"><?php echo strtoupper($formulir[0]->nama_lengkap); ?></a>
                                                <!--end::Name-->
                                                <span class="label label-light-success label-inline font-weight-bolder mr-1"><?php echo strtoupper($formulir[0]->nama_panggilan); ?></span>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="card card-custom mb-10">
                        <div class="card-body py-4 mt-4 mb-3">
                            <h3 class="card-label text-dark font-weight-bolder">STATUS PEMBAYARAN</h3>
                    ...
                    <div class="card card-custom mb-10">
                        <div class="text-center mb-5 mt-5">
                            ...
                            if ($formulir[0]->status_pembayaran == 1) {
                                ?>
                                <button onclick="act_confirm_payment_ppdb('<?php echo paramEncrypt($formulir[0]->id_formulir); ?>', '<?php echo strtoupper($formulir[0]->nama_lengkap); ?>')" class="btn btn-success btn-sm font-weight-bold px-8 py-4 my-3 mx-4"><i class="fas fa-check-circle "></i>Terima</button>
                                            ...
                                            if (!empty($cost)) {
                                                foreach ($cost as $key => $value) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <select name="id_voucher" id="id_voucher<?php echo $value->id_biaya; ?>" class="form-control font-weight-bolder  form-control-md" disabled="">
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Bukti Pembayaran "<?php echo strtoupper($formulir[0]->nama_lengkap); ?>"</h5>
            ...
            <div class="modal-body text-center">
                <?php if ($formulir[0]->keterangan != NULL || $formulir[0]->keterangan != "") { ?>
                    <span class="text-center text-danger font-weight-bold font-size-md">Ket: <?php echo ucwords($formulir[0]->keterangan); ?></span>
                <?php } ?>
                <div class="text-center">
                    <img alt="Pic" class="col-12" src="<?php echo base_url() . $formulir[0]->bukti_transfer ?>">
                    <a href="<?php echo base_url() . $formulir[0]->bukti_transfer ?>" class="btn btn-success btn-sm py-3 px-4" download><i class="fas fa-download"></i> Download</a>         
                </div>
            </div>
        ...
        Swal.fire({
            ...
            preConfirm: (value) => {
                return $.ajax({
                    ...
                    data: {id: id, keterangan: value, [csrfName]: csrfHash},
                    dataType: 'html',
