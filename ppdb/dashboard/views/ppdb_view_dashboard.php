            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex flex-column">
                    ...
                    <div class="d-flex align-items-center font-weight-bold my-2">
                        ...
                        <!--begin::Item-->
                        <span class="label label-dot label-sm bg-white opacity-75 mx-3"></span>
                        <a href="" class="text-white text-hover-white opacity-75 hover-opacity-100">Dashboard PPDB Admin</a>
                        <!--end::Item-->
                    </div>
                    <!--end::Breadcrumb-->
                </div>
                ...
                <div class="col-xl-2 col-6">
                    ...
                    <div class="card card-custom bg-info gutter-b" >
                        <div class="card-body">
                            ...
                            <div class="text-inverse-primary font-weight-bolder font-size-h2 mt-3 text-white"><?php echo $insight_dash[0]->laki_laki; ?></div>
                            <a href="#" class="text-inverse-primary font-weight-bold font-size-lg mt-1 text-white">CALON LAKI-LAKI</a>
                        </div>
                    </div>
                    <!--end::Tiles Widget 11-->
                </div>
                ...
                <div class="col-xl-2 col-6">
                    ...
                    <div class="card card-custom bg-warning gutter-b">
                        <div class="card-body">
                            ...
                            <div class="text-inverse-primary font-weight-bolder font-size-h2 mt-3 text-white"><?php echo $insight_dash[0]->perempuan; ?></div>
                            <a href="#" class="text-inverse-primary font-weight-bold font-size-lg mt-1 text-white">CALON PEREMPUAN</a>
                        </div>
                    </div>
                    <!--end::Tiles Widget 11-->
                </div>
                ...
                <div class="col-xl-2 col-6">
                    ...
                    <div class="card card-custom bg-success gutter-b">
                        <div class="card-body">
                            ...
                            <div class="text-inverse-primary font-weight-bolder font-size-h2 mt-3 text-white"><?php echo $insight_dash[0]->diterima; ?></div>
                            <a href="#" class="text-inverse-primary font-weight-bold font-size-lg mt-1 text-white">SISWA DITERIMA</a>
                        </div>
                    </div>
                    <!--end::Tiles Widget 11-->
                </div>
                ...
                <div class="col-xl-2 col-6">
                    ...
                    <div class="card card-custom bg-danger gutter-b">
                        <div class="card-body">
                            ...
                            <div class="text-inverse-primary font-weight-bolder font-size-h2 mt-3 text-white"><?php echo $insight_dash[0]->ditolak; ?></div>
                            <a href="#" class="text-inverse-primary font-weight-bold font-size-lg mt-1 text-white">SISWA DITOLAK</a>
                        </div>
                    </div>
                    <!--end::Tiles Widget 11-->
                </div>
                ...
                <div class="col-xl-2 col-6">
                    ...
                    <div class="card card-custom bg-primary gutter-b">
                        <div class="card-body">
                            ...
                            <div class="text-inverse-primary font-weight-bolder font-size-h2 mt-3 text-white"><?php echo $insight_dash[0]->pendaftar; ?></div>
                            <a href="#" class="text-inverse-primary font-weight-bold font-size-lg mt-1 text-white">PENDAFTAR</a>
                        </div>
                    </div>
                    <!--end::Tiles Widget 11-->
                </div>
                ...
                <div class="col-xl-2 col-6">
                    ...
                    <div class="card card-custom bg-success gutter-b">
                        <div class="card-body">
                            ...
                            <div class="text-inverse-primary font-weight-bolder font-size-h2 mt-3 text-white"><?php echo $insight_dash[0]->pembeli; ?></div>
                            <a href="#" class="text-inverse-primary font-weight-bold font-size-lg mt-1 text-white">PEMBELI FORM</a>
                        </div>
                    </div>
                    <!--end::Tiles Widget 11-->
                </div>
                    ...
                    <div class="card card-custom gutter-b">
                        ...
                        <div class="card-header h-auto">
                            ...
                            <div class="card-title py-5">
                                <h3 class="card-label">Grafik PPDB Tiap 3 Tahun</h3>
                            </div>
                            <!--end::Title-->
                        </div>
                        <!--end::Header-->
                            ...
                            <div class="card card-custom mb-7">
                                <div class="card-body d-flex p-0">
                                    <div class="flex-grow-1 bg-success p-5 card-rounded flex-grow-1 bgi-no-repeat" style="background-position: calc(100% + 0.8rem) bottom;background-size: auto 50%; background-image: url(<?php echo base_url(); ?>assets/ppdb/dist/assets/media/svg/icons/home/door-open.svg);">
                                        <h4 class="text-inverse-danger font-weight-bolder">Aktifkan PPDB</h4>
                                        <p class="text-inverse-danger my-2">Tahun Ajaran <?php echo $schoolyear[0]->tahun_ajaran; ?></p>
                            ...
                            <div class="card card-custom mb-7">
                                <div class="card-body d-flex p-0">
                                    <div class="flex-grow-1 bg-primary p-5 card-rounded flex-grow-1 bgi-no-repeat" style="background-position: calc(100% + 0.8rem) bottom;background-size: auto 50%;background-image: url(<?php echo base_url(); ?>assets/ppdb/dist/assets/media/svg/icons/files/uploaded-file.svg);">
                                        <h4 class="text-inverse-danger font-weight-bolder">Aktifkan Kuota</h4>
                                        <p class="text-inverse-danger my-2">Tahun Ajaran <?php echo $schoolyear[0]->tahun_ajaran; ?></p>
                                        <input data-switch="true" data-size="small" type="checkbox" disabled="" data-on-color="success" data-off-color="danger" />
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12 col-12">
                            <div class="card card-custom mt-0">
                                ...
                                <div class="card-header h-auto">
                                    <!--begin::Title-->
                                    <div class="card-title py-5">
                                        <h3 class="card-label">PPDB Insight</h3>
                                    </div>
                                    <!--end::Title-->
                                </div>
                                <!--end::Header-->
