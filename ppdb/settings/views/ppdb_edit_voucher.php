			...
			<div class="d-flex align-items-center flex-wrap mr-1">
				...
				<div class="d-flex flex-column">
					...
					<div class="d-flex align-items-center font-weight-bold my-2">
						...
						<!--begin::Item-->
						<span class="label label-dot label-sm bg-white opacity-75 mx-3"></span>
						<a href="" class="text-white text-hover-white opacity-75 hover-opacity-100">Edit Voucher Sekolah</a>
						<!--end::Item-->
					</div>
					<!--end::Breadcrumb-->
				</div>
				...
				<div class="col-lg-12" id="kt_form">
					...
					<div class="card card-custom">
						<div class="card-header">
							<h3 class="card-title">
								Edit Voucher Sekolah
							</h3>
						</div>
						<!--begin::Form-->
						<form class="form" novalidate="novalidate" action="<?php echo site_url('ppdb/settings/voucher/update_voucher/') . paramEncrypt($voucher[0]->id_voucher); ?>" enctype="multipart/form-data" method="post" id="kt_add_voucher_form">
								...
								<div class="row">
									<div class="col-lg-2">
										<div class="form-group">
											...
											<input type="text" name="kode_voucher" value="<?php echo $voucher[0]->kode_voucher; ?>" class="form-control form-control-lg" placeholder="Isikan Kode Voucher" />
									...
									<div class="col-lg-4">
										<div class="form-group">
											...
											<input type="text" name="nama_voucher" value="<?php echo $voucher[0]->nama_voucher; ?>" class="form-control form-control-lg" placeholder="Isikan Nama Voucher" />
									...
									<div class="col-lg-3">
										<div class="form-group">
											...
											<div class="input-group">
												<input type="text" name="potongan" value="<?php echo $voucher[0]->potongan; ?>" class="form-control  form-control-lg" placeholder="Isikan Potongan Voucher" />
									...
									<div class="col-lg-3">
										<div class="form-group">
											...
											<input type="text" name="jumlah_voucher" value="<?php echo $voucher[0]->jumlah_voucher; ?>" class="form-control  form-control-lg" placeholder="Isikan Jumlah Voucher" />
								...
								<div class="row">
									<div class="col-lg-3">
										<div class="form-group">
											...
											<select name="id_jenis_voucher" id="id_jenis_voucher" class="form-control form-control-lg">
												<option value="<?php echo $voucher[0]->id_jenis_voucher; ?>" selected="">
													<?php
													if ($voucher[0]->id_jenis_voucher == 1) {
														echo 'Pendaftaran (Formulir)';
													} else if ($voucher[0]->id_jenis_voucher == 2) {
									...
									<div class="col-lg-7">
										<div class="form-group">
											...
											<span class="form-text text-dark"><b class="text-danger">*WAJIB DIISI, </b>pilih Tujuan Potongan Voucher</span>
										</div>
									</div>
									<div class="col-lg-2">
										<div class="form-group">
											<label>Masa Berlaku</label>
											<input type="text" name="masa_berlaku" value="<?php echo $voucher[0]->masa_berlaku; ?>" id="kt_datepicker_1" class="form-control  form-control-lg" placeholder="Isikan Masa Berlaku" readonly="" />
								...
								<div class="row">
									<div class="col-lg-12">
										<div class="form-group">
											...
											<textarea name="syarat_ketentuan" id="kt-ckeditor-1"><?php echo $voucher[0]->syarat_ketentuan; ?></textarea>
...
<script>
	$(document).ready(function() {
		var id_cost = <?php echo $voucher[0]->id_jenis_voucher ?>;
		var id_nama = <?php echo $voucher[0]->id_nama_biaya ?>;

		var url = "<?php echo site_url('/ppdb/settings/voucher/add_ajax_cost_option_edit'); ?>/" + id_cost + "/" + id_nama;
