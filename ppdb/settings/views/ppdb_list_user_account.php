			...
			<div class="d-flex align-items-center flex-wrap mr-1">
				...
				<div class="d-flex flex-column">
					...
					<div class="d-flex align-items-center font-weight-bold my-2">
						...
						<!--begin::Item-->
						<span class="label label-dot label-sm bg-white opacity-75 mx-3"></span>
						<a href="" class="text-white text-hover-white opacity-75 hover-opacity-100">Daftar Akun</a>
						<!--end::Item-->
					</div>
					<!--end::Breadcrumb-->
				</div>
							...
							<div class="mb-7">
								<div class="row align-items-center">
									...
									<div class="col-lg-3 col-xl-4 text-right">
										<a href="<?php echo site_url("/ppdb/settings/account/add_account"); ?>" class="btn btn-primary btn-md">
								...
								<tbody>
									...
									?>
											<tr>
												...
												<td><?php echo $value->role_akun; ?></td>
													...
													<div class="dropdown dropdown-inline">
														...
														<div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
															<ul class="navi flex-column navi-hover py-2">
																...
																<li class="navi-item">
																	<a href="<?php echo site_url("/ppdb/settings/account/edit_account/" . paramEncrypt($value->id_akun_ppdb)); ?>" class="navi-link">
																		<span class="navi-icon"><i class="la la-edit text-success"></i></span>
																		<span class="navi-text">Edit</span>
																	</a>
																</li>
																<li class="navi-item">
																	<a href="javascript:act_delete_account('<?php echo paramEncrypt($value->id_akun_ppdb); ?>', '<?php echo strtoupper($value->nama_akun); ?>')" class="navi-link">
...
<!--end::Content-->
<script src="<?php echo base_url(); ?>assets/ppdb/dist/assets/js/pages/crud/ktdatatable/base/html-table-account.js">
</script>
<script>
	function act_delete_account(id, name) {
		...
		Swal.fire({
			...
			if (result.value) {
				$.ajax({
					type: "post",
					url: "<?php echo site_url("/ppdb/settings/account/delete_account") ?>",
					data: {
						id: id,
						[csrfName]: csrfHash
					},
