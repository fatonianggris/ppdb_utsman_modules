...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Login Admin PPDB | Sekolah Utsman</title>
        <meta name="description" content="Login Sekolah Utsman" />
        ...
        <link href="<?php echo base_url(); ?>assets/ppdb/dist/assets/css/pages/login/classic/login-4.css" rel="stylesheet" type="text/css" />
        ...
        <link href="<?php echo base_url(); ?>assets/ppdb/dist/assets/css/themes/layout/header/base/light.css" rel="stylesheet" type="text/css" />
        <link href="<?php echo base_url(); ?>assets/ppdb/dist/assets/css/themes/layout/header/menu/light.css" rel="stylesheet" type="text/css" />
        <link href="<?php echo base_url(); ?>assets/ppdb/dist/assets/css/themes/layout/brand/dark.css" rel="stylesheet" type="text/css" />
        <link href="<?php echo base_url(); ?>assets/ppdb/dist/assets/css/themes/layout/aside/dark.css" rel="stylesheet" type="text/css" />
        <!--end::Layout Themes-->
    ...
    <body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
        ...
        <div class="d-flex flex-column flex-root">
            ...
            <div class="login login-4 login-signin-on d-flex flex-row-fluid" id="kt_login">
                <div class="d-flex flex-center flex-row-fluid bgi-size-cover bgi-position-top bgi-no-repeat" style="background-image: url('<?php echo base_url(); ?>assets/ppdb/dist/assets/media/bg/bg-7.jpg');">
                    <div class="login-form text-center p-7 position-relative overflow-hidden">
                        ...
                        <div class="login-signin">
                            <div class="mb-5">
                                <h4 class="font-weight-bolder text-white">Login Sistem PPDB</h4>
                                <h1 class="font-weight-bolder text-warning">Sekolah Utsman</h1>
                                <div class="text-danger font-weight-bold">Silahkan login sesuai Email dan Password anda:</div>
                            </div>
                            <?php echo $this->session->flashdata('flash_message'); ?>
                            <form class="form" novalidate="novalidate" method="POST" action="<?php echo base_url(); ?>ppdb/auth/login"  id="kt_login_signin_form_ppdb">
                            ...
                            <div class="mt-10">
                                <span class="mr-1 text-warning">2021©</span>
                                <a href="http://keenthemes.com/metronic" target="_blank" class="text-warning text-hover-primary">Sekolah Utsman</a>
                            </div>
                        </div>
                        ...
                        <div class="login-forgot">
                            <div class="mb-0">
                                <h3 class="text-white font-weight-bolder">Lupa Kata Sandi ?</h3>
                ...
                function act_reset_password() {
                    ...
                    Swal.fire({
                        ...
                        preConfirm: () => {
                            return $.ajax({
                                type: "post",
                                url: "<?php echo site_url("ppdb/settings/account/reset_password") ?>",
                                data: {email: email},
                                dataType: 'html',
        ...
        <script src="<?php echo base_url(); ?>assets/ppdb/dist/assets/js/pages/custom/login/login-ppdb.js"></script>
        <!--end::Page Scripts-->
    </body>
    <!--end::Body-->
</html>
