			...
			<div class="d-flex align-items-center flex-wrap mr-1">
				...
				<div class="d-flex flex-column">
					...
					<div class="d-flex align-items-center font-weight-bold my-2">
						...
						<!--begin::Item-->
						<span class="label label-dot label-sm bg-white opacity-75 mx-3"></span>
						<a href="" class="text-white text-hover-white opacity-75 hover-opacity-100">Edit Pengumuman Jadwal</a>
						<!--end::Item-->
					</div>
					<!--end::Breadcrumb-->
				</div>
				...
				<div class="col-lg-12" id="kt_form">
					...
					<div class="card card-custom">
						<div class="card-header">
							<h3 class="card-title">
								Edit Pengumuman Jadwal
							</h3>
						</div>
						<!--begin::Form-->
						<form class="form" novalidate="novalidate" action="<?php echo site_url('ppdb/announcement/schedule/update_schedule/' . paramEncrypt($schedule[0]->id_jadwal_ppdb)); ?>" enctype="multipart/form-data" method="post" id="kt_add_schedule_form">
								...
								<div class="row">
									<div class="col-lg-4">
										<div class="form-group">
											...
											<input type="text" name="nama_jadwal" value="<?php echo $schedule[0]->nama_jadwal; ?>" class="form-control form-control-lg" placeholder="Isikan Nama Jadwal" />
									...
									<div class="col-lg-2">
										<div class="form-group">
											...
											<input type="text" name="tanggal_jadwal" value="<?php echo $schedule[0]->tanggal_jadwal; ?>" id="kt_datepicker_1" class="form-control form-control-lg" placeholder="Isikan Tanggal Jadwal" readonly="" />
									...
									<div class="col-lg-2">
										<div class="form-group">
											...
											<input type="text" name="jam_jadwal" value="<?php echo $schedule[0]->jam_jadwal; ?>" id="kt_timepicker_2" class="form-control  form-control-lg" placeholder="Isikan Jam Jadwal" readonly="" />
									...
									<div class="col-lg-4">
										<div class="form-group">
											<label>Lokasi</label>
											<input type="text" name="lokasi" value="<?php echo $schedule[0]->lokasi; ?>" class="form-control  form-control-lg" placeholder="Isikan Lokasi" />
								...
								<div class="row">
									<div class="col-lg-12">
										<div class="form-group">
											...
											<textarea name="keterangan" id="kt-ckeditor-1"> <?php echo $schedule[0]->keterangan; ?></textarea>
