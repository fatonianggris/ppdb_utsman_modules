    ...
    public function export_data_csv()
    {
        ...
        if ($data['data_check'] == '' or $data['data_check'] == null || empty($data['data_check'] || !$data['data_check'])) {
            ...
            foreach ($empInfo as $element) {
                ...
                $sheet->setCellValue('AV' . $rowCount, trim(preg_replace('/\r|\n/', '', preg_replace('/,/', '.', $element['alamat_rumah_kk']))));
                ...
                $sheet->setCellValue('BD' . $rowCount, trim(preg_replace('/\r|\n/', '', preg_replace('/,/', '.', $element['alamat_rumah_dom']))));
