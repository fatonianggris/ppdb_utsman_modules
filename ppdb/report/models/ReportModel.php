...
class ReportModel extends CI_Model
{
	...
	public function get_data_export_register($id = '')
	{
		$this->db->select("s.*, 
		...
		$this->db->join('tahun_ajaran ta', 's.id_tahun_ajaran = ta.id_tahun_ajaran', 'left');
		$this->db->where_in('s.id_pendaftaran', $id);
