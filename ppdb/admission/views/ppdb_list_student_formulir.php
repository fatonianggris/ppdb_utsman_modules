            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex flex-column">
                    ...
                    <div class="d-flex align-items-center font-weight-bold my-2">
                        ...
                        <!--begin::Item-->
                        <span class="label label-dot label-sm bg-white opacity-75 mx-3"></span>
                        <a href="" class="text-white text-hover-white opacity-75 hover-opacity-100">Daftar Pembelian
                            Formulir</a>
                        <!--end::Item-->
                    </div>
                    <!--end::Breadcrumb-->
                    ...
                    <div class="card card-custom bg-success gutter-b">
                        <div class="card-body">
                            ...
                            <div class="text-inverse-primary font-weight-bolder font-size-h2 mt-3 text-white">
                                <?php echo $insight_sold[0]->sudah_dibayar; ?></div>
                ...
                <div class="col-xl-2 col-6">
                    ...
                    <div class="card card-custom bg-danger gutter-b">
                        <div class="card-body">
                            ...
                            <div class="text-inverse-primary font-weight-bolder font-size-h2 mt-3 text-white">
                                <?php echo $insight_sold[0]->belum_dibayar; ?></div>
                ...
                <div class="col-xl-2 col-6">
                    ...
                    <div class="card card-custom bg-primary gutter-b">
                        <div class="card-body">
                            ...
                            <div class="text-inverse-primary font-weight-bolder font-size-h2 mt-3 text-white">
                                <?php echo $insight_sold[0]->kb; ?></div>
                            <a href="#"
                ...
                <div class="col-xl-2 col-6">
                    ...
                    <div class="card card-custom bg-primary gutter-b">
                        <div class="card-body">
                            ...
                            <div class="text-inverse-primary font-weight-bolder font-size-h2 mt-3 text-white">
                                <?php echo $insight_sold[0]->tk; ?></div>
                            <a href="#"
                                class="text-inverse-primary font-weight-bold font-size-lg mt-1 text-white">Jenjang
                                TK</a>
                        </div>
                ...
                <div class="col-xl-2 col-6">
                    ...
                    <div class="card card-custom bg-primary gutter-b">
                        <div class="card-body">
                            ...
                            <div class="text-inverse-primary font-weight-bolder font-size-h2 mt-3 text-white">
                                <?php echo $insight_sold[0]->sd; ?></div>
                            <a href="#"
                                class="text-inverse-primary font-weight-bold font-size-lg mt-1 text-white">Jenjang
                                SD</a>
                        </div>
                ...
                <div class="col-xl-2 col-6">
                    ...
                    <div class="card card-custom bg-primary gutter-b">
                        <div class="card-body">
                            ...
                            <div class="text-inverse-primary font-weight-bolder font-size-h2 mt-3 text-white">
                                <?php echo $insight_sold[0]->smp; ?></div>
                            <a href="#"
                                class="text-inverse-primary font-weight-bold font-size-lg mt-1 text-white">Jenjang
                                SMP</a>
                        </div>
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <div class="dropdown-menu">
                                                <form class="form" id="frm-excel"
                                                    action="<?php echo site_url('ppdb/report/export_data_register_csv'); ?>"
                                                    method="POST">
