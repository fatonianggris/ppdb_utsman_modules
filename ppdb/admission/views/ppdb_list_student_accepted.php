            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex flex-column">
                    ...
                    <div class="d-flex align-items-center font-weight-bold my-2">
                        ...
                        <!--begin::Item-->
                        <span class="label label-dot label-sm bg-white opacity-75 mx-3"></span>
                        <a href="" class="text-white text-hover-white opacity-75 hover-opacity-100">Daftar Peserta
                            Diterima</a>
                        <!--end::Item-->
                    </div>
                    <!--end::Breadcrumb-->
                    ...
                    <div class="card card-custom bg-success gutter-b">
                        <div class="card-body">
                            ...
                            <div class="text-inverse-primary font-weight-bolder font-size-h2 mt-3 text-white">
                                <?php echo $insight_accepted[0]->laki_laki; ?></div>
                            <a href="#"
                                class="text-inverse-primary font-weight-bold font-size-lg mt-1 text-white">LAKI-LAKI</a>
                        </div>
                    </div>
                    <!--end::Tiles Widget 11-->
                </div>
                ...
                <div class="col-xl-2 col-6">
                    ...
                    <div class="card card-custom bg-warning gutter-b">
                        <div class="card-body">
                            ...
                            <div class="text-inverse-primary font-weight-bolder font-size-h2 mt-3 text-white">
                                <?php echo $insight_accepted[0]->perempuan; ?></div>
                            <a href="#"
                                class="text-inverse-primary font-weight-bold font-size-lg mt-1 text-white">PEREMPUAN</a>
                        </div>
                    </div>
                    <!--end::Tiles Widget 11-->
                </div>
                ...
                <div class="col-xl-2 col-6">
                    ...
                    <div class="card card-custom bg-primary gutter-b">
                        <div class="card-body">
                            ...
                            <div class="text-inverse-primary font-weight-bolder font-size-h2 mt-3 text-white">
                                <?php echo $insight_accepted[0]->kb; ?></div>
                            <a href="#"
                                class="text-inverse-primary font-weight-bold font-size-lg mt-1 text-white">Jenjang
                                KB</a>
                        </div>
                    </div>
                    <!--end::Tiles Widget 11-->
                ...
                <div class="col-xl-2 col-6">
                    ...
                    <div class="card card-custom bg-primary gutter-b">
                        <div class="card-body">
                            ...
                            <div class="text-inverse-primary font-weight-bolder font-size-h2 mt-3 text-white">
                                <?php echo $insight_accepted[0]->tk; ?></div>
                            <a href="#"
                                class="text-inverse-primary font-weight-bold font-size-lg mt-1 text-white">Jenjang
                                TK</a>
                        </div>
                ...
                <div class="col-xl-2 col-6">
                    ...
                    <div class="card card-custom bg-primary gutter-b">
                        <div class="card-body">
                            ...
                            <div class="text-inverse-primary font-weight-bolder font-size-h2 mt-3 text-white">
                                <?php echo $insight_accepted[0]->sd; ?></div>
                            <a href="#"
                                class="text-inverse-primary font-weight-bold font-size-lg mt-1 text-white">Jenjang
                                SD</a>
                        </div>
                ...
                <div class="col-xl-2 col-6">
                    ...
                    <div class="card card-custom bg-primary gutter-b">
                        <div class="card-body">
                            ...
                            <div class="text-inverse-primary font-weight-bolder font-size-h2 mt-3 text-white">
                                <?php echo $insight_accepted[0]->smp; ?></div>
                            <a href="#"
                                class="text-inverse-primary font-weight-bold font-size-lg mt-1 text-white">Jenjang
                                SMP</a>
                        </div>
                    ...
                    <div class="card card-custom">
                        <div class="card-body">
                            ...
                            <div class="mb-7">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-lg-1 col-xl-1">
                                        <div class="btn-group">
                                            <button class="btn btn-primary font-weight-bold btn-md dropdown-toggle"
                                            ...
                                            <div class="dropdown-menu">
                                                ...
                                                <form class="form" id="frm-form"
                                                    ...
                                                    <input type="text" id="id_check_form" class="form-control" value=""
                                                        name="data_check" style="display:none">
                                                    <button class="dropdown-item" role="button" type="submit"><i
                                                            class="flaticon2-box-1"></i> Formulir .pdf</button>
                                                </form>
                                                <form class="form" id="frm-files"
                                                    action="<?php echo site_url('ppdb/admission/export_student_files'); ?>"
                                                    method="POST">
                                                    <input type="text" id="id_check_files" class="form-control" value=""
                                                        name="data_check" style="display:none">
                                                    <button class="dropdown-item" role="button" type="submit"><i
                                                            class="flaticon2-box-1"></i> Berkas .pdf</button>
                                                </form>
                                            </div>
                                        </div>
                            ...
                            <table class="datatable datatable-bordered datatable-head-custom"
                                id="kt_datatable_admission_accepted">
                                <thead>
                                    <tr>
                                        <th title="ID">ID</th>
                                            ...
                                            <div class="dropdown dropdown-inline">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                                                    <ul class="navi flex-column navi-hover py-2">
                                                        ...
                                                        <li class="navi-item">
                                                            <a href="<?php echo site_url("/ppdb/admission/detail_student_accepted/" . paramEncrypt($value->id_formulir)); ?>"
                                                                class="navi-link">
                                                        ...
                                                        <?php } ?>
                                                        <li class="navi-item">
                                                            <a href="<?php echo site_url("/ppdb/admission/print_student_formulir/" . paramEncrypt($value->id_formulir)); ?>"
                                                                class="navi-link">
                                                                <span class="navi-icon"><i
                                                                        class="la la-file-download text-warning"></i></span>
...
<!--end::Content-->
<script
    src="<?php echo base_url(); ?>assets/ppdb/dist/assets/js/pages/crud/ktdatatable/base/html-table-admission-accepted.js">
</script>
