        ...
        <div class="container">
            <div class="row">
                            ...
                            <div class="d-flex">
                                ...
                                <div class="flex-shrink-0 mr-0">
                                    ...
                                    <div class="symbol symbol-50 symbol-lg-100 symbol-light-danger">
                                        <span
                                            class="font-size-h2 symbol-label font-weight-boldest"><?php echo strtoupper(substr($student[0]->nama_lengkap, 0, 2)); ?></span>
                                    </div>
                                    <?php } else { ?>
                                    ...
                                    <div class="d-flex align-items-center justify-content-between flex-wrap">
                                        ...
                                        <div class="mr-2">
                                            <div class="d-flex align-items-center mr-2">
                                                <!--begin::Name-->
                                                <a href="#"
                                                    class="d-flex align-items-center text-dark text-hover-primary font-size-h5 font-weight-bold mr-3"><?php echo strtoupper($student[0]->nama_lengkap); ?></a>
                                                <!--end::Name-->
                                                <span
                                                    class="label label-light-success label-inline font-weight-bolder mr-1"><?php echo strtoupper($student[0]->nama_panggilan); ?></span>
                ...
                <div class="col-lg-3 col-md-6 col-sm-12">
                    <div class="card card-custom mb-10">
                        <div class="card-body py-4 mt-4 mb-4">
                            <h3 class="card-label text-dark font-weight-bolder text-center">STATUS PENERIMAAAN</h3>
                            <div class="d-flex flex-lg-grow-1 justify-content-lg-center mt-5 text-center">
                                <?php if ($student[0]->status_penerimaan == 0) { ?>
                                <p class="font-weight-boldest display-3 text-warning">
                                    DIPROSES
                                </p>
                                <?php } else if($student[0]->status_penerimaan == 1){ ?>
                                <p class="font-weight-boldest display-3 text-success">
                                    DITERIMA
                                </p>
                                <?php } else if($student[0]->status_penerimaan == 1){ ?>
                                <p class="font-weight-boldest display-3 text-danger">
                                    DITOLAK
                                </p>
                                <?php } ?>
                            </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-12">
                    <div class="card card-custom mb-10">
                        <div class="card-body py-4 mt-4 mb-6">
                            <h3 class="card-label text-dark font-weight-bolder  text-center">STATUS PEMBAYARAN</h3>
                            <div class="d-flex flex-lg-grow-1 justify-content-lg-center mt-8 text-center">
                                <?php if ($student[0]->status_pembayaran == 0) { ?>
                                <p class="font-weight-boldest display-4 text-danger">
                                    BELUM BAYAR
                                </p>
                                <?php } else if ($student[0]->status_pembayaran >= 1) { ?>
                                <p class="font-weight-boldest display-4 text-success">
                                    SUDAH BAYAR
                                </p>
                                <?php } ?>
                            </div>
                                    ...
                                    <div class="form-group row my-2">
                                        ...
                                        <div class="col-3">
                                            <button class="btn btn-sm btn-primary px-2 py-2 my-3 mx-2"
                                                data-toggle="modal" data-target="#modal_kk">Kartu Keluarga</button>
                                        </div>
                                        <div class="col-5">
                                            <button class="btn btn-sm btn-primary px-2 py-2 my-3 mx-2"
                                                data-toggle="modal" data-target="#modal_akta">Akta Kelahiran</button>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="font-size-h6 font-weight-bold text-danger mb-5">Data Periodik Siswa
                                    </div>
                                    <div class="form-group row my-2">
                                    ...
                                    <div class="font-size-h7 font-weight-bold text-danger mb-3 mt-4">NIS & Nama Saudara
                                        Bersekolah disini</div>
                                    <div class="form-group row my-2">
                ...
                <div class="col-xl-12">
                    ...
                    <div class="card card-custom mb-10">
                        ...
                        <div class="card-body py-4">
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-12 ">
                                    <div class="font-size-h6 font-weight-bold text-danger mb-5">Alamat Kartu Keluarga
                                    </div>
                                    <div class="form-group row my-2">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12 ">
                                    <div class="font-size-h6 font-weight-bold text-danger mb-5">Alamat Domisili Sekarang
                                    </div>
                                    <div class="form-group row my-2">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body text-center">
                <div class="text-center">
                    ...
                    <a href="<?php echo base_url() . $student[0]->kartu_keluarga ?>"
                        class="btn btn-success btn-sm py-3 px-4 mt-3" download><i class="fas fa-download"></i>
                        Download</a>
                </div>
            </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body text-center">
                <div class="text-center">
                    ...
                    <a href="<?php echo base_url() . $student[0]->akta_kelahiran ?>"
                        class="btn btn-success btn-sm py-3 px-4 mt-3" download><i class="fas fa-download"></i>
                        Download</a>
                </div>
            </div>
        ...
        preConfirm: () => {
            return $.ajax({
                ...
                success: function(result) {
                    Swal.fire("Disetujui!", "Calon '" + name +
                        "' telah diterima sebagai Siswa Baru.", "success");
                    setTimeout(function() {
                        location.reload();
                    }, 1000);
                },
    ...
    Swal.fire({
        ...
        preConfirm: (text) => {
            return $.ajax({
                ...
                dataType: 'html',
                success: function(result) {
                    Swal.fire("Ditolak!", "Calon '" + name +
                        "' telah ditolak sebagai Siswa Baru.", "success");
                    setTimeout(function() {
                        location.reload();
                    }, 1000);
                },
