            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex flex-column">
                    ...
                    <div class="d-flex align-items-center font-weight-bold my-2">
                        ...
                        <!--begin::Item-->
                        <span class="label label-dot label-sm bg-white opacity-75 mx-3"></span>
                        <a href="" class="text-white text-hover-white opacity-75 hover-opacity-100">Konfirmasi Peneriamaan Siswa</a>
                        <!--end::Item-->
                    </div>
                    <!--end::Breadcrumb-->
                </div>
                    ...
                    <div class="card card-custom mb-10">
                        <div class="card-body py-4 mt-4 mb-4">
                            ...
                            <div class="d-flex flex-lg-grow-1 justify-content-lg-center mt-5 text-center">
                                <?php if ($student[0]->status_penerimaan == 1) { ?>
        ...
        Swal.fire({
            ...
            preConfirm: () => {
                return $.ajax({
                    ...
                    data: {id: id, id_voucher: get_voucher(), total_biaya: get_total(), id_kelas: id_kelas, [csrfName]: csrfHash},
                    dataType: 'html',
                    success: function (result) {
                        Swal.fire("Disetujui!", "Calon '" + name + "' telah diterima sebagai Siswa Baru.", "success");
                        setTimeout(function () {
                            location.reload();
                        }, 1000);
                    },
