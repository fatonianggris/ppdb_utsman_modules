				...
				<div class="login-form text-center p-7 position-relative overflow-hidden">
					...
					<?php if ($formulir[0]->status_pembayaran == 0) { ?>
						...
						<div class="login-signin">
							...
							<div class="mb-10 ">
								<p class="font-mobile font-weight-boldest text-success ">ANDA BELUM MELAKUKAN PEMBAYARAN</p>
								<div class="font-weight-bold text-danger font-size-lg">Silahkan melakukan pembayaran UANG SEKOLAH terlebih dahulu. Berikut merupakan informasi terkait tagihan Anda:</div>
							</div>
