...
<body id="kt_body" style="background-image: url(<?php echo base_url(); ?>assets/ppdb/dist/assets/media/bg/bg-10.jpg)" class="quick-panel-right demo-panel-right offcanvas-right header-fixed subheader-enabled page-loading">
	...
	<div class="d-flex flex-column flex-root">
		...
		<div class="login login-1 login-signin-on d-flex flex-column flex-lg-row flex-column-fluid bg-white" id="kt_login">
			<!--begin::Aside-->
			<div class="login-aside d-flex flex-row-auto bgi-size-cover bgi-no-repeat p-10 p-lg-10" style="background-image: url(<?php echo base_url(); ?>assets/ppdb/dist/assets/media/bg/bg-4.jpg);">
				...
				<div class="d-flex flex-row-fluid flex-column justify-content-between">
					...
					<div class="flex-column-fluid d-flex flex-column mt-5">
						<h3 class="font-size-h1 mb-5 text-white">SPPDB <?php echo $page[0]->nama_website; ?></h3>
						<p class="font-weight-lighter text-white opacity-80"><?php echo $page[0]->greeting_website; ?>.</p>
						<!--end: Aside content-->
			...
			<div class="d-flex flex-column flex-row-fluid position-relative p-7 overflow-hidden">
				...
				<!--begin::Content body-->
				<div class="d-flex flex-column-fluid flex-center mt-10 mt-lg-0 px-mobile-2">
					<!--begin::Signup-->
					<div class="login-form login-signin">
						<div class="text-center mb-10 mb-lg-10">
							<h3 class="font-size-h1 text-warning font-weight-bold">Upload Ulang Bukti Pembayaran</h3>
							<p class="text-dark-75 font-weight-bold">Isikan <b class="text-danger">NOMOR PENDAFTARAN</b> yang telah Kami kirimkan ke Email Anda. </p>
						</div>
						<!--begin::Form-->
						<?php echo $this->session->flashdata('flash_message'); ?>
						<form class="form" method="POST" action="<?php echo base_url(); ?>/ppdb/register/post_check_payment" enctype="multipart/form-data" novalidate="novalidate" id="kt_check_payment">
							...
							<div class="form-group d-flex flex-wrap flex-center">
								<button id="kt_login_signin_submit" class="btn btn-success font-weight-bold px-9 py-4 my-3 mx-4">Cek Status</button>
