                ...
                <div class="d-flex flex-column-fluid flex-center mt-10 mt-lg-0 px-mobile-2">
                    ...
                    <div class="login-form login-signin">
                        <div class="text-center mb-10 mb-lg-10">
                            <h3 class="font-size-h1 text-warning font-weight-bold">Cek Status Pembayaran</h3>
                            <p class="text-dark-75 font-weight-bold">Isikan <b class="text-danger">NOMOR FORMULIR</b>
                                yang telah Kami kirimkan ke Email Anda. </p>
                        </div>
                        <!--begin::Form-->
                        <?php echo $this->session->flashdata('flash_message'); ?>
                        <form class="form" method="POST"
                            action="<?php echo base_url(); ?>/ppdb/register/post_check_payment"
                            enctype="multipart/form-data" novalidate="novalidate" id="kt_check_payment">
                            <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>"
                                value="<?php echo $this->security->get_csrf_hash(); ?>">
                            <div class="row">
                                <div class="col-xl-12">
                                    <div class="form-group text-center">
                                        <label class="font-size-md font-weight-bold">Pilih Pembayaran</label>
                                        <div class="row text-left">
                                            <div class="col-lg-6">
                                                <label class="option">
                                                    <span class="option-control">
                                                        <span class="radio radio-bold radio-brand" />
                                                        <input type="radio" name="opsi_pembayaran" value="1" />
                                                        <span></span>
                                                    </span>
                                                    </span>
                                                    <span class="option-label">
                                                        ...
                                                        <span class="option-body text-dark-75">
                                                            Pastikan Anda telah melakukan pembayaran Formulir PPDB.
                                                        </span>
                                                    </span>
                                                </label>
                                            </div>
                                            <div class="col-lg-6">
                                                <label class="option">
                                                    <span class="option-control">
                                                        <span class="radio radio-bold radio-brand">
                                                            <input type="radio" name="opsi_pembayaran" value="2" />
                                                            <span></span>
                                                        </span>
                                                    </span>
                                                    <span class="option-label">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control form-control-solid h-auto py-5 px-6" type="text"
                                            placeholder="Isikan Nomor Formulir" name="nomor_formulir" />
                                        <span class="form-text text-dark"><b class="text-danger">*WAJIB DIISI,
                                            </b>isikan <b class="text-danger">NOMOR FORMULIR</b> yang telah Kami
                                            kirimkan ke email Anda. </span>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group d-flex flex-wrap flex-center">
                                <button id="kt_login_signin_submit"
                                    class="btn btn-success font-weight-bold px-9 py-4 my-3 mx-4">Cek Status</button>
