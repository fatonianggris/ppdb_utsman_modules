...
<body id="kt_body" style="background-image: url(<?php echo base_url(); ?>assets/ppdb/dist/assets/media/bg/bg-10.jpg)" class="quick-panel-right demo-panel-right offcanvas-right header-fixed subheader-enabled page-loading">
	...
	<div class="d-flex flex-column flex-root">
		...
		<div class="login login-1 login-signin-on d-flex flex-column flex-lg-row flex-column-fluid bg-white" id="kt_login">
			...
			<div class="d-flex flex-column flex-row-fluid position-relative p-7 overflow-hidden">
				...
				<!--begin::Content body-->
				<div class="d-flex flex-column-fluid flex-center px-mobile-2 mt-10 mt-lg-0">
					<!--begin::Signup-->
					<div class="login-form login-signin">
						<div class="text-center mb-10 mb-lg-10">
							<h3 class="font-size-h1 text-warning font-weight-bolder">Login Cek Status Penerimaan</h3>
						...
						<form class="form" novalidate="novalidate" method="POST" action="<?php echo base_url(); ?>/ppdb/register/auth_login_announcement" id="kt_login_announcement">
							...
							<div class="form-group fv-plugins-icon-container mt-5">
								...
								<div class="fv-plugins-message-container"> </div>
								<span class="form-text text-dark"><b class="text-danger">*WAJIB DIISI, </b>isikan Password Anda </span>
							</div>
							<!--begin::Action-->
							...
							<div class="form-group d-flex flex-wrap flex-center">
								<button id="kt_login_signin_submit" class="btn btn-success font-weight-bold px-9 py-4 my-3 mx-4">Login</button>
	...
	<script src="<?php echo base_url(); ?>assets/ppdb/dist/assets/js/pages/custom/login/login-announcement.js"></script>
	<!--end::Page Scripts-->
