                ...
                <div class="d-flex flex-center flex-row-fluid bgi-size-cover bgi-position-top bgi-no-repeat" style="background-image: url('<?php echo base_url(); ?>assets/ppdb/dist/assets/media/bg/bg-3.jpg');">
                    <div class="login-form p-7 position-relative overflow-hidden">
                        ...
                        <div class="mb-10 text-center">
                            ...
                            <div class="font-weight-bold text-success font-size-lg">Silahakn mengisi formulir data diri Anda, Berikut merupakan kolom formulir pengisian:</div>
                        </div>
                        <!--end::Login Header-->
                        <!--begin::Entry-->
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-xl-3">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <span class="form-text text-dark"><b class="text-danger">*WAJIB DIISI, </b>isikan Jenis Kelamin</span>
                                                                        </div>
                                                                        <!--end::Select-->
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                                                    <div class="col-xl-3">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <span class="form-text text-dark"><b class="text-danger">*WAJIB DIISI, </b>isikan Agama siswa</span>
                                                                        </div>
                                                                        <!--end::Select-->
                                                                    </div>
                                                                    <div class="col-xl-3">
                                                                    ...
                                                                    <div class="col-xl-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <span class="form-text text-dark"><b class="text-danger">*WAJIB DIISI, </b>isikan Tahun Ajaran</span>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-xl-5">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <span class="form-text text-dark"><b class="text-danger">*WAJIB DIISI, </b>isikan Pendidikan Ayah</span>
                                                                            <!--end::Select-->
                                                                        </div>
                                                                        <!--end::Input-->
                                                                    </div>
                                                                    <div class="col-xl-5">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <span class="form-text text-dark"><b class="text-danger">*WAJIB DIISI, </b>isikan Penghasilan Ayah</span>
                                                                        </div>
                                                                        <!--end::Input-->
                                                                    </div>
                                                                    <div class="col-xl-2">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-xl-4">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <span class="form-text text-dark"><b class="text-danger">*WAJIB DIISI, </b>isikan Pekerjaan Ibu</span>
                                                                            <!--end::Select-->
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-xl-5">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <span class="form-text text-dark"><b class="text-danger">*WAJIB DIISI, </b>isikan Pendidikan Ibu</span>
                                                                            <!--end::Select-->
                                                                        </div>
                                                                        <!--end::Input-->
                                                                    </div>
                                                                    <div class="col-xl-5">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <span class="form-text text-dark"><b class="text-danger">*WAJIB DIISI, </b>isikan Penghasilan Ibu</span>
                                                                        </div>
                                                                        <!--end::Input-->
                                                                    </div>
                                                                    <div class="col-xl-2">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-xl-5">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <span class="form-text text-dark"><b class="text-danger">*WAJIB DIISI, </b>isikan Pendidikan Wali</span>
                                                                            <!--end::Select-->
                                                                        </div>
                                                                        <!--end::Input-->
                                                                    </div>
                                                                    <div class="col-xl-5">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <span class="form-text text-dark"><b class="text-danger">*WAJIB DIISI, </b>isikan Penghasilan Wali</span>
                                                                        </div>
                                                                        <!--end::Input-->
                                                                    </div>                                            
                                                                </div>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-xl-5">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <span class="form-text text-dark"><b class="text-danger">*WAJIB DIISI, </b>isikan Jenis Tempat Tinggal Siswa</span>
                                                                        </div>   
                                                                    </div>
                                                                    <div class="col-xl-4">
                                                                        <div class="form-group">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="radio-inline">
                                                                                <label class="radio radio-lg">
                                                                                    <input type="radio" name="kebutuhan_khusus" value="0">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-xl-4">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <span class="form-text text-dark"><b class="text-danger">*WAJIB DIISI, </b>isikan Tingkat Siswa</span>
                                                                        </div>
                                                                    </div>
            ...
            $(document).ready(function () {
                ...
                $('#wali_ayah').click(function () {
                    ...
                    if ($(this).prop("checked") == true) {
                        ...
                        $('#kt_daterangepicker_wali').daterangepicker({singleDatePicker: true, showDropdowns: true}, "option", "disabled", true);
                        $('#kt_daterangepicker_ayah').daterangepicker({singleDatePicker: true, showDropdowns: true}, "option", "disabled", true);
            ...
            $(document).ready(function () {
                ...
                $('#wali_ibu').click(function () {
                    if ($(this).prop("checked") == true) {
                        ...
                        $('select[name="penghasilan_wali"] option:not(:selected)').prop('disabled', true);
                        $('#kt_daterangepicker_wali').daterangepicker({singleDatePicker: true, showDropdowns: true}, "option", "disabled", true);
                        $('#kt_daterangepicker_ibu').daterangepicker({singleDatePicker: true, showDropdowns: true}, "option", "disabled", true);
