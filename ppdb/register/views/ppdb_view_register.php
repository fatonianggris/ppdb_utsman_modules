	...
	<script>
		...
		$("#jalur").change(function() {
			...
			if (id_jalur == 2) {
				...
				$('<span class="form-text text-dark"><b class="text-danger">*Jika kuota jalur ICP sudah terpenuhi, maka siswa akan dimasukan kuota jalur Reguler. Terima kasih!</b></span>').empty().append('#content');
			}
			return false;
		});
