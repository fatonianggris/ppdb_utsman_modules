...
<head>
    <meta charset="utf-8" />
    <title>Alur PPDB| Sekolah Utsman </title>
            ...
            <div class="d-flex flex-center flex-row-fluid bgi-size-cover bgi-position-top bgi-no-repeat"
                ...
                <div class="login-form text-center p-7 position-relative overflow-hidden">
                    ...
                    <div class="login-signin">
                        <div class="mb-0 ">
                            <p class="font-mobile font-weight-boldest text-warning ">ALUR PPDB SEKOLAH UTSMAN</p>
                        </div>
                        <div class="px-mobile">
                            <div class="alert alert-custom alert-light-danger alert-shadow fade show" role="alert">
                                ...
                                <div class="alert-text">Berikut ini merupakan Alur PPDB Sekolah Utsman, Silahkan
                                    Mengikuti Alur Untuk Memudahkan Anda.</div>
                            </div>
                        </div>
                        <div class="timeline timeline-4 px-mobile">
                            ...
                            <div class="timeline-items">
                                    ...
                                    <div class="timeline-content">
                                        <div class="d-flex align-items-center p-2">
                                            ...
                                            <div class="d-flex flex-column text-left">
                                                <div class="text-dark-75">Untuk PPDB ONLINE, calon peserta didik
                                                    melakukan pembelian formulir secara <b>ONLINE</b> melalui <b>WEB
                                                        RESMI PPDB SEKOLAH UTSMAN</b> <a
                                                        href="https://ppdb.sekolahutsman.sch.id/ppdb/home/">www.ppdb.sekolahutsman.sch.id/</a>
                                                    <a>atau datang ke TU untuk pembelian OFFLINE</a>
                                                </div>
                                ...
                                <div class="timeline-item timeline-item-left">
                                    ...
                                    <div class="timeline-label">
                                        <span class="text-warning font-size-lg font-weight-boldest">1. Beli
                                            Formulir</span>
                                    </div>
                                    ...
                                    <div class="timeline-content">
                                        <div class="d-flex align-items-center p-2">
                                            ...
                                            <div class="d-flex flex-column text-left">
                                                <div class="text-dark-75">Calon peserta didik melakukan pembelian dan
                                                    pengisian formulir dengan mengisikan <b>KELENGKAPAN DATA DIRI</b>
                                                    dan melakukan <b>PEMBAYARAN</b></div>
                                                <div class="mt-3">
                                                    <a href="<?php echo site_url("/ppdb/register") ?>"
                                                        class="btn btn-sm font-weight-bolder text-uppercase btn-warning py-3 px-5">Beli
                                                        Sekarang</a>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="timeline-item timeline-item-right">
                                    ...
                                    <div class="timeline-label text-primary">
                                        <span class="text-warning font-size-lg font-weight-boldest">2. Upload Bukti
                                            Pembayaran Formulir</span>
                                    </div>
                                    <div class="timeline-content">
                                        <div class="d-flex align-items-center p-2">
                                            <div class="mr-2">
                                                    ...
                                                    <svg xmlns="http://www.w3.org/2000/svg"
                                                        ...
                                                        <g stroke="none" stroke-width="1" fill="none"
                                                            ...
                                                            <path
                                                                ...
                                                                fill="#000000" />
                                                            <rect fill="#000000" opacity="0.3" x="9" y="4" width="6"
                                                                height="2" rx="1" />
                                                            <circle fill="#000000" opacity="0.3" cx="12" cy="13"
                                                                r="2" />
                                                        </g>
                                                    </svg>
                                                    <!--end::Svg Icon-->
                                            ...
                                            <div class="d-flex flex-column text-left">
                                                <div class="text-dark-75">Calon peserta didik melakukan <b> UPLOAD BUKTI
                                                        PEMBAYARAN FORMULIR</b> melalui link di bawah ini. Bukti
                                                    pembayaran berupa file <b> .jpg </b>, <b> .jpeg </b> atau <b> .png
                                                    </b> dengan maksimum size <b> 5 mb </b></div>
                                                <div class="mt-3">
                                                    <a href="<?php echo site_url("/ppdb/register/upload_payment_receipt"); ?>"
                                                        class="btn btn-sm font-weight-bolder text-uppercase btn-warning py-3 px-5">Upload
                                                        Sekarang</a>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="timeline-item timeline-item-left">
                                    ...
                                    <div class="timeline-label">
                                        <span class="text-warning font-size-lg font-weight-boldest">3. Cek Status
                                            Pembayaran Formulir</span>
                                    </div>
                                    <div class="timeline-content">
                                        <div class="d-flex align-items-center p-2">
                                            ...
                                            <div class="d-flex flex-column text-left">
                                                <div class="text-dark-75">Calon peserta didik akan menerima <b>
                                                        E-INVOICE </b> jika pembayaran telah diverifikasi. Status
                                                    pembayaran dapat dilihat <b> PALING LAMBAT 2 x 24 JAM </b> setelah
                                                    bukti pembayaran diupload. Bukti pembayaran bisa ditukar dengan
                                                    souvenir cantik ke Panitia PPDB di Sekolah Utsman </div>
                                                <div class="mt-3">
                                ...
                                <div class="timeline-item timeline-item-right">
                                    ...
                                    <div class="timeline-label">
                                        <span class="text-warning font-size-lg font-weight-boldest">4. Upload Berkas
                                            PPDB Siswa</span>
                                    </div>
                                    ...
                                    <div class="timeline-content">
                                        <div class="d-flex align-items-center p-2">
                                            ...
                                            <div class="d-flex flex-column text-left">
                                                <div class="text-dark-75">Calon peserta didik mengupload kelengkapan
                                                    formulir secara <b> ONLINE</b>. Gunakan <b> NOMOR FORMULIR </b> dan
                                                    <b> PASSWORD </b> yang telah dikirim ke <b> EMAIL </b> anda untuk
                                                    <b> LOGIN </b>
                                                </div>
                                                <div class="mt-3">
                                                    <a href="<?php echo site_url("/ppdb/register/login_formulir"); ?>"
                                                        class="btn btn-sm font-weight-bolder text-uppercase btn-warning py-3 px-5">Upload
                                                        Sekarang</a>
                                                </div>
                                            </div>
                                ...
                                <div class="timeline-item timeline-item-left">
                                    ...
                                    <div class="timeline-label">
                                        <span class="text-warning font-size-lg font-weight-boldest">5. Pembayaran Biaya
                                            Sekolah</span>
                                    </div>
                                        ...
                                        <div class="d-flex align-items-center p-2">
                                            ...
                                            <div class="d-flex flex-column text-left">
                                                <div class="text-dark-75">
                                                    Calon peserta didik akan menerima <b>
                                                        PESAN WHATSAPP & EMAIL</b> Rincian Tagihan Biaya Sekolah berupa
                                                    VA (virtual account) Bank BSI <b>PALING LAMBAT 2 x
                                                        24 JAM </b> setelah upload kelengkapan formulir.
                                                    <br>
                                                    <p class="text-danger font-size-sm"><br>*Calon peserta didik
                                                        <b>DIWAJIBKAN</B> membayar melalui <b> VA (virtual account)</b>.
                                                        <br>*Silahakan <b>CEK PEMBAYARAN</b> dengan menginputkan <b> NOMOR FORMULIR</b> untuk melihat <b>STATUS TAGIHAN & TATA CARA
                                                        PEMBAYARAN.</b>
                                                    </p>
                                                </div>
                                                <div class="mt-1">
                                ...
                                <div class="timeline-item timeline-item-right">
                                    ...
                                    <div class="timeline-label">
                                        <span class="text-warning font-size-lg font-weight-boldest">4. Proses
                                            Observasi Calon Siswa</span>
                                    </div>
                                    ...
                                    <div class="timeline-content">
                                        <div class="d-flex align-items-center p-2">
                                            ...
                                            <div class="d-flex flex-column text-left">
                                                <div class="text-dark-75">Peserta Didik menunggu info dari sekolah
                                                    terkait jadwal observasi calon peserta didik yang diumukan di
                                                    website.</div>
                                                <!--                                                    <div class="mt-3">
                                ...
                                <div class="timeline-item timeline-item-left">
                                    ...
                                    <div class="timeline-label">
                                        <span class="text-warning font-size-lg font-weight-boldest">6. Cek Status
                                            Penerimaan Siswa</span>
                                    </div>
                                    ...
                                    <div class="timeline-content">
                                        <div class="d-flex align-items-center p-2">
                                            ...
                                            <div class="d-flex flex-column text-left">
                                                <div class="text-dark-75">Peserta didik mengecek penerimaan siswa baru
                                                    dengan login di halaman cek penerimaan siswa.</div>
                                                <div class="mt-3">
                                                    <a href="<?php echo site_url("/ppdb/register/login_announcement"); ?>"
                                                        class="btn btn-sm font-weight-bolder text-uppercase btn-warning py-3 px-5">Cek
                                                        Sekarang</a>
                                ...
                                <div class="timeline-item timeline-item-right">
                                    ...
                                    <div class="timeline-content">
                                        <div class="d-flex align-items-center p-2">
                                            ...
                                            <div class="d-flex flex-column text-left">
                                                <div class="text-dark-75">Terimakasih telah memilih Sekolah Islam
                                                    Terpadu Utsman Bin Affan.</div>
                        ...
                        <a href="<?php echo site_url('ppdb/home'); ?>" type="button"
                            class="btn btn-primary mt-10 font-weight-bold px-9 py-4 my-3 mx-4 ">
                    ...
                    <div
                        class="d-flex flex-column-auto flex-column flex-sm-row justify-content-center align-items-center mt-5 p-5">
                        <div class="text-dark-50 font-weight-bold order-2 order-sm-1 my-2">© 2021 Sekolah Ustman</div>
                    </div>
...
if ($contact[0]->no_handphone_sma != "" or $contact[0]->no_handphone_sma != null) {?>
    ...
    <script src="<?php echo base_url(); ?>assets/ppdb/dist/assets/js/pages/custom/login/login-general.js"></script>
    <!--end::Page Scripts-->
