                        ...
                        <div class="login-signin">
                            ...
                            <div class="px-mobile">
                                <div class="alert alert-custom alert-light-danger alert-shadow fade show" role="alert">
                                    ...
                                    <div class="alert-text">Berikut ini merupakan Alur PPDB Sekolah Utsman, Silahkan Mengikuti Alur Untuk Memudahkan Anda.</div>
                                </div>
                            </div>
                            <div class="timeline timeline-4 px-mobile">
                                ...
                                <div class="timeline-items">
                                        ...
                                        <div class="timeline-content">
                                            <div class="d-flex align-items-center p-2">
                                                ...
                                                <div class="d-flex flex-column text-left">
                                                    <div class="text-dark-75">Untuk PPDB ONLINE, calon peserta didik melakukan pembelian formulir secara <b>ONLINE</b> melalui <b>WEB RESMI PPDB SEKOLAH UTSMAN</b> <a href="https://ppdb.sekolahutsman.sch.id/ppdb/home/">www.ppdb.sekolahutsman.sch.id/</a> <a>atau datang ke TU untuk pembelian OFFLINE</a></div>
                                    ...
                                    <div class="timeline-item timeline-item-left">
                                        ...
                                        <div class="timeline-label">
                                            <span class="text-warning font-size-lg font-weight-boldest">1. Beli Formulir</span>
                                        </div>
                                    ...
                                    <div class="timeline-item timeline-item-right">
                                        ...
                                        <div class="timeline-label text-primary">
                                            <span class="text-warning font-size-lg font-weight-boldest">2. Upload Bukti Pembayaran Formulir</span>
                                        </div>
                                        <div class="timeline-content">
                                            <div class="d-flex align-items-center p-2">
                                                <div class="mr-2">
                                                ...
                                                <div class="d-flex flex-column text-left">
                                                    <div class="text-dark-75">Calon peserta didik melakukan <b> UPLOAD BUKTI PEMBAYARAN FORMULIR</b> melalui link di bawah ini. Bukti pembayaran berupa file <b> .jpg </b>, <b> .jpeg </b> atau <b> .png </b> dengan maksimum size <b> 5 mb </b></div>
                                                    <div class="mt-3">
                                                        <a href="<?php echo site_url("/ppdb/register/upload_payment_receipt"); ?>" class="btn btn-sm font-weight-bolder text-uppercase btn-warning py-3 px-5">Upload Sekarang</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="timeline-item timeline-item-left">
                                        ...
                                        <div class="timeline-label">
                                            <span class="text-warning font-size-lg font-weight-boldest">3. Cek Status Pembayaran Formulir</span>
                                        </div>
                                        <div class="timeline-content">
                                            <div class="d-flex align-items-center p-2">
                                                <div class="mr-2">
                                                ...
                                                <div class="d-flex flex-column text-left">
                                                    <div class="text-dark-75">Calon peserta didik akan menerima <b> E-INVOICE </b> jika pembayaran telah diverifikasi. Status pembayaran dapat dilihat <b> PALING LAMBAT 2 x 24 JAM </b> setelah bukti pembayaran diupload. Bukti pembayaran bisa ditukar dengan souvenir cantik ke Panitia PPDB di Sekolah Utsman  </div>
                                                    <div class="mt-3">
                                                        <a href="<?php echo site_url("/ppdb/register/check_status_payment"); ?>" class="btn btn-sm font-weight-bolder text-uppercase btn-warning py-3 px-5">Cek Sekarang</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="timeline-item timeline-item-left">
                                        ...
                                        <div class="timeline-label">
                                            <span class="text-warning font-size-lg font-weight-boldest">5. Observasi Siswa</span>
                                        </div>
                                        ...
                                        <div class="timeline-content">
                                            <div class="d-flex align-items-center p-2">
                                                ...
                                                <div class="d-flex flex-column text-left">
                                                    <div class="text-dark-75">Peserta Didik menunggu info dari sekolah terkait jadwal observasi calon peserta didik yang diumukan di website.</div>
                                                    <!--                                                    <div class="mt-3">
                                    ...
                                    <div class="timeline-item timeline-item-right">
                                        ...
                                        <div class="timeline-label">
                                            <span class="text-warning font-size-lg font-weight-boldest">6. Cek Status Penerimaan Siswa</span>
                                        </div>
                                        ...
                                        <div class="timeline-content">
                                            <div class="d-flex align-items-center p-2">
                                                ...
                                                <div class="d-flex flex-column text-left">
                                                    <div class="text-dark-75">Peserta didik mengecek penerimaan siswa baru dengan login di halaman cek penerimaan siswa.</div>
                                                    <div class="mt-3">
                                                        <a href="<?php echo site_url("/ppdb/register/login_announcement"); ?>" class="btn btn-sm font-weight-bolder text-uppercase btn-warning py-3 px-5">Cek Sekarang</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="timeline-item timeline-item-left">
                                        ...
                                        <div class="timeline-content">
                                            <div class="d-flex align-items-center p-2">
                                                ...
                                                <div class="d-flex flex-column text-left">
                                                    <div class="text-dark-75">Terimakasih telah memilih Sekolah Islam Terpadu Utsman Bin Affan.</div>
                            ...
                            <a href="<?php echo site_url('ppdb/home'); ?>" type="button" class="btn btn-primary mt-10 font-weight-bold px-9 py-4 my-3 mx-4 "><li class="fa fa-home font-size-h4"></li> Kembali ke Menu</a>
